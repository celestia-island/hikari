...
| Simplified Chinese | `zh-Hans` | `Language::ChineseSimplified` | LTR |
| Traditional Chinese | `zh-Hant` | `Language::ChineseTraditional` | LTR |
...
fn App() -> Element {
    ...
    let toml_content = match language() {
        ...
        Language::ChineseSimplified => ZH_HANS_TOML,
        Language::ChineseTraditional => ZH_HANT_TOML,
