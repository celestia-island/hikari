...
spotlight::Config {
 ...
 color: "#FFB3A7", // Couleur de la lueur
...
```rust
// yes Bon - Uniquement lors de l'interaction utilisateur
button {
 onmouseenter: move |_| {
...
// no À éviter - Animation continue
loop {
