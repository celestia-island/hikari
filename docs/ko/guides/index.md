...
### 전통 중국 색채
- 주요: 석청 (청록/파랑), 주사 (진홍/빨강), 등황 (등황/노랑)
- 중성: 월백 (연한 흰색), 묵색 (먹색), 효색 (연한 회색)
- 기능: 총청 (성공), 아황 (경고), 주사 (위험)
...
│   ├── hikari-builder/          # 빌드 시스템
│   └── hikari-render-service/   # SSR 서비스
│
└── examples/
    ├── website/                 # 공식 웹사이트
