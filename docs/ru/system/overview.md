...
**Обязанности**:
- Предоставляет более 660 определений традиционных китайских цветов
...
- **Hikari (Светлая)** - Светлая тема
  - Основной: Розовый (#FFB3A7)
  - Вторичный: Киноварь (#519A73)
  - Акцент: Винный жёлтый (#FFC773)

- **Tairitsu** - Тёмная тема
  - Основной: Утиный синий (#144A74)
  - Вторичный: Киноварь (#519A73)
  - Акцент: Гусиный жёлтый (#FFC773)
