...
//! # Why Absolute Paths?
//!
//! When using relative paths like `./assets/demo_app.js`:
//! - On route `/` → requests `/assets/demo_app.js` ✅
//! - On route `/components` → requests `/components/assets/demo_app.js` ❌
//!
//! With absolute paths like `/assets/demo_app.js`:
//! - On route `/` → requests `/assets/demo_app.js` ✅
//! - On route `/components` → requests `/assets/demo_app.js" ✅
...
pub const STATIC_PATHS: StaticPaths = StaticPaths {
    ...
    wasm_js: "/assets/demo_app.js",
    wasm_bg: "/assets/demo_app_bg.wasm",
