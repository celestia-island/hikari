...
use _components::{Button, ButtonVariant, Empty, layout::{Container, Section}};
use _palette::classes::{ClassesBuilder, FontSize, FontWeight, MarginBottom, Padding, TextColor};

#[allow(non_snake_case)]
pub fn ComponentsEmpty() -> Element {
    rsx! {
        Layout {
            current_route: Route::DisplayEmpty {},
            ...
            Container {
                ...
                Section {
                    ...
                    div { class: ClassesBuilder::new().add(MarginBottom::Mb8).build(),
                        ...
                        div { class: ClassesBuilder::new().add(Padding::P6).build(),
                            code { r#"Empty {{ description: "No data available".to_string() }}"# }
                        }
                    }
