...
use _components::{
    display::{Tag as TagComponent, TagVariant},
            ...
            Container {
                ...
                Section {
                    ...
                    div { class: ClassesBuilder::new().add(MarginBottom::Mb8).build(),
                        ...
                        div { class: ClassesBuilder::new().add(Display::Flex).add(Gap::Gap4).add(Padding::P6).build(),
                            TagComponent { variant: TagVariant::Default, "JavaScript" }
                            TagComponent { variant: TagVariant::Default, "TypeScript" }
                            TagComponent { variant: TagVariant::Default, "CSS" }
                        }
                    }
                    ...
                    div { class: ClassesBuilder::new().add(MarginBottom::Mb8).build(),
                        ...
                        div { class: ClassesBuilder::new().add(Display::Flex).add(Gap::Gap4).add(Padding::P6).build(),
                            TagComponent { variant: TagVariant::Primary, "Frontend" }
                            TagComponent { variant: TagVariant::Primary, "Backend" }
                            TagComponent { variant: TagVariant::Primary, "DevOps" }
                        }
                    }
                    ...
                    div { class: ClassesBuilder::new().add(MarginBottom::Mb8).build(),
                        ...
                        div { class: ClassesBuilder::new().add(Display::Flex).add(Gap::Gap4).add(Padding::P6).build(),
                            TagComponent { variant: TagVariant::Success, "Completed" }
                            TagComponent { variant: TagVariant::Success, "Active" }
                            TagComponent { variant: TagVariant::Success, "Passed" }
                        }
                    }
                    ...
                    div { class: ClassesBuilder::new().add(MarginBottom::Mb8).build(),
                        ...
                        div { class: ClassesBuilder::new().add(Display::Flex).add(Gap::Gap4).add(Padding::P6).build(),
                            TagComponent { variant: TagVariant::Warning, "Pending" }
                            TagComponent { variant: TagVariant::Warning, "Review" }
                            TagComponent { variant: TagVariant::Warning, "Beta" }
                        }
                    }
                    ...
                    div { class: ClassesBuilder::new().add(MarginBottom::Mb8).build(),
                        ...
                        div { class: ClassesBuilder::new().add(Display::Flex).add(Gap::Gap4).add(Padding::P6).build(),
                            TagComponent { variant: TagVariant::Danger, "Error" }
                            TagComponent { variant: TagVariant::Danger, "Failed" }
                            TagComponent { variant: TagVariant::Danger, "Deleted" }
                        }
                    }
                    ...
                    div { class: ClassesBuilder::new().add(MarginBottom::Mb8).build(),
                        ...
                        div { class: ClassesBuilder::new().add(Display::Flex).add(Gap::Gap4).add(Padding::P6).build(),
                            TagComponent { variant: TagVariant::Info, "Info" }
                            TagComponent { variant: TagVariant::Info, "Note" }
                            TagComponent { variant: TagVariant::Info, "Documentation" }
                        }
                    }
                }
                ...
                Section {
                    ...
                    div { class: ClassesBuilder::new().add(MarginBottom::Mb8).build(),
                        ...
                        div { class: ClassesBuilder::new().add(Display::Flex).add(Gap::Gap4).add(Padding::P6).build(),
                            ...
                            TagComponent { variant: TagVariant::Success, "Active" }
                            TagComponent { variant: TagVariant::Warning, "Beta" }
                            TagComponent { variant: TagVariant::Info, "v2.0" }
                        }
                    }
                    ...
                    div { class: ClassesBuilder::new().add(MarginBottom::Mb8).build(),
                        ...
                        div { class: ClassesBuilder::new().add(Display::Flex).add(Gap::Gap4).add(Padding::P6).build(),
                            TagComponent { variant: TagVariant::Default, "Rust" }
                            TagComponent {
                                variant: TagVariant::Primary,
                                closable: true,
                                "WebAssembly"
                            }
                            TagComponent { variant: TagVariant::Success, "Stable" }
                            TagComponent {
                ...
                Section {
                    ...
                    div { class: ClassesBuilder::new().add(MarginBottom::Mb8).build(),
                        ...
                        div { class: ClassesBuilder::new().add(Padding::P6).build(),
                            code { r#"TagComponent {{ variant: TagVariant::Primary, "Category" }}"# }
                        }
                    }
