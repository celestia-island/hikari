...
pub fn render() -> VNode {
    render_demo_page("page-component-zoom-controls", "Zoom Controls", "Zoom in, zoom out, and reset controls for canvas viewers, maps, and image previews.", VNode::Fragment(vec![
