                ...
                div {
                    ...
                    div { class: ClassesBuilder::new().add(MarginBottom::Mb8).build(),
                        ...
                        div {
                            ...
                            div {
                                class: ClassesBuilder::new().add(BgColor::White).add(BorderRadius::Rounded).add(Padding::P4).build(),
                                div { class: ClassesBuilder::new().add(Display::Block).add(MarginBottom::Mb2).build(), "Block" }
                                div { class: ClassesBuilder::new().add(Display::InlineBlock).add(MarginBottom::Mb2).build(), "Inline" }
                                div { class: ClassesBuilder::new().add(Display::InlineBlock).add(Display::Hidden).add(MarginBottom::Mb2).build(), "Inline + Hidden" }
                            }
                            div {
                                class: ClassesBuilder::new().add(BgColor::White).add(BorderRadius::Rounded).add(Padding::P4).build(),
                            ...
                            div {
                                class: ClassesBuilder::new().add(BgColor::White).add(BorderRadius::Rounded).add(Padding::P4).build(),
                                div { class: ClassesBuilder::new().add(Display::Hidden).add(MarginBottom::Mb2).build(), "Hidden" }
                            }
                        }
                    }
                        ...
                        div {
                            ...
                            div {
                                ...
                                div { class: ClassesBuilder::new().add(Display::Flex).add(FlexDirection::Row).add(Gap::Gap2).build(),
                                    div { class: ClassesBuilder::new().add(BgColor::Surface).add(Padding::P3).add(MarginBottom::Mb2).build(), "Item 1" }
                                    div { class: ClassesBuilder::new().add(BgColor::Surface).add(Padding::P3).add(MarginBottom::Mb2).build(), "Item 2" }
                                }
                            }
                            div {
                                class: ClassesBuilder::new().add(BgColor::White).add(BorderRadius::Rounded).add(Padding::P4).build(),
                    ...
                    div { class: ClassesBuilder::new().add(MarginBottom::Mb8).build(),
                        ...
                        div {
                            ...
                            div {
                                ...
                                div { class: ClassesBuilder::new().add(Display::Flex).add(Gap::Gap3).build(),
                                    div { class: ClassesBuilder::new().add(BgColor::Surface).add(Padding::P3).build(), "M0" }
                                    div { class: ClassesBuilder::new().add(BgColor::Surface).add(Padding::P3).build(), "M2" }
                                    div { class: ClassesBuilder::new().add(BgColor::Surface).add(Padding::P3).build(), "M4" }
                                }
                            }
                        }
                    }
