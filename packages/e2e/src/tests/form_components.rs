...
impl FormComponentsTests {
    async fn test_form(&self, driver: &WebDriver) -> Result<TestResult> {
        ...
        let form = driver.find(By::Css(".hi-form")).await.map_err(|e| {
            ...
            anyhow!("Form element not found: {}", e)
        })?;
        ...
        let class_attr = form
            .attr("class")
            .await
            .map_err(|e| anyhow!("Failed to get form attributes: {}", e))?;
        let class_attr =
            class_attr.ok_or_else(|| anyhow!("No class attribute found for form"))?;
    ...
    async fn test_select(&self, driver: &WebDriver) -> Result<TestResult> {
        ...
        let select = driver.find(By::Css(".hi-select")).await.map_err(|e| {
            ...
            anyhow!("Select element not found: {}", e)
        })?;
        ...
        select
            .click()
            .await
            .map_err(|e| anyhow!("Failed to click select: {}", e))?;
        ...
        let class_attr = select
            .attr("class")
            .await
            .map_err(|e| anyhow!("Failed to get select attributes: {}", e))?;
        let class_attr =
            class_attr.ok_or_else(|| anyhow!("No class attribute found for select"))?;
    ...
    async fn test_checkbox(&self, driver: &WebDriver) -> Result<TestResult> {
        ...
        let checkbox = driver.find(By::Css(".hi-checkbox")).await.map_err(|e| {
            ...
            anyhow!("Checkbox element not found: {}", e)
        })?;
        ...
        checkbox
            .click()
            .await
            .map_err(|e| anyhow!("Failed to click checkbox: {}", e))?;
        info!("Checkbox clicked successfully");

        let class_attr = checkbox
            .attr("class")
            .await
            .map_err(|e| anyhow!("Failed to get checkbox attributes: {}", e))?;
        let class_attr =
            class_attr.ok_or_else(|| anyhow!("No class attribute found for checkbox"))?;
    ...
    async fn test_radio(&self, driver: &WebDriver) -> Result<TestResult> {
        ...
        let radio = driver.find(By::Css(".hi-radio")).await.map_err(|e| {
            ...
            anyhow!("Radio element not found: {}", e)
        })?;
        ...
        radio
            .click()
            .await
            .map_err(|e| anyhow!("Failed to click radio: {}", e))?;
        info!("Radio clicked successfully");

        let class_attr = radio
            .attr("class")
            .await
            .map_err(|e| anyhow!("Failed to get radio attributes: {}", e))?;
        let class_attr =
            class_attr.ok_or_else(|| anyhow!("No class attribute found for radio"))?;
    ...
    async fn test_switch(&self, driver: &WebDriver) -> Result<TestResult> {
        ...
        let switch = driver.find(By::Css(".hi-switch")).await.map_err(|e| {
            ...
            anyhow!("Switch element not found: {}", e)
        })?;
        ...
        switch
            .click()
            .await
            .map_err(|e| anyhow!("Failed to click switch: {}", e))?;
        info!("Switch clicked successfully");

        let class_attr = switch
            .attr("class")
            .await
            .map_err(|e| anyhow!("Failed to get switch attributes: {}", e))?;
        let class_attr =
            class_attr.ok_or_else(|| anyhow!("No class attribute found for switch"))?;
    ...
    async fn test_carousel(&self, driver: &WebDriver) -> Result<TestResult> {
        ...
        let carousel = driver.find(By::Css(".hi-carousel")).await.map_err(|e| {
            ...
            anyhow!("Carousel element not found: {}", e)
        })?;
        ...
        let class_attr = carousel
            .attr("class")
            .await
            .map_err(|e| anyhow!("Failed to get carousel attributes: {}", e))?;
        let class_attr =
            class_attr.ok_or_else(|| anyhow!("No class attribute found for carousel"))?;
        ...
        driver
            ...
            .map_err(|e| {
                ...
                anyhow!("Carousel track not found: {}", e)
            })?;
        ...
        let carousel_items = driver
            ...
            .map_err(|e| {
                ...
                anyhow!("Carousel items not found: {}", e)
            })?;
        ...
        let prev_button = driver
            ...
            .map_err(|e| {
                ...
                anyhow!("Previous button not found: {}", e)
            })?;

        prev_button
            .click()
            .await
            .map_err(|e| anyhow!("Failed to click previous button: {}", e))?;
        ...
        let carousel_dots = driver
            ...
            .map_err(|e| {
                ...
                anyhow!("Carousel dots not found: {}", e)
            })?;
        ...
        driver
            ...
            .map_err(|e| {
                ...
                anyhow!("Active carousel dot not found: {}", e)
            })?;
    ...
    async fn test_stepper(&self, driver: &WebDriver) -> Result<TestResult> {
        ...
        let stepper = driver.find(By::Css(".hi-stepper")).await.map_err(|e| {
            ...
            anyhow!("Stepper element not found: {}", e)
        })?;
        ...
        let class_attr = stepper
            .attr("class")
            .await
            .map_err(|e| anyhow!("Failed to get stepper attributes: {}", e))?;
        let class_attr =
            class_attr.ok_or_else(|| anyhow!("No class attribute found for stepper"))?;
        ...
        let step_numbers = driver
            ...
            .map_err(|e| {
                ...
                anyhow!("Step numbers not found: {}", e)
            })?;
        ...
        let active_step = driver.find(By::Css(".hi-step-active")).await.map_err(|e| {
            ...
            anyhow!("Active step not found: {}", e)
        })?;
        ...
        let active_class_attr = active_step
            .attr("class")
            .await
            .map_err(|e| anyhow!("Failed to get active step attributes: {}", e))?;

        let active_class_attr = active_class_attr
            .ok_or_else(|| anyhow!("No class attribute found for active step"))?;
