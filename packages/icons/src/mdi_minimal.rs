...
impl std::fmt::Display for MdiIcon {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            ...
            MdiIcon::AlertTriangle => write!(f, "alert-triangle"),
            ...
            MdiIcon::MessageSquare => write!(f, "message-square"),
            ...
            MdiIcon::List => write!(f, "list"),
            MdiIcon::Upload => write!(f, "upload"),
            MdiIcon::Panel => write!(f, "panel"),
            MdiIcon::Maximize2 => write!(f, "maximize-2"),
            MdiIcon::ChevronsUpDown => write!(f, "chevrons-up-down"),
            MdiIcon::Tune => write!(f, "tune"),
            MdiIcon::Pulse => write!(f, "pulse"),
            MdiIcon::Loading => write!(f, "loading"),
            MdiIcon::Code => write!(f, "code"),
...
impl std::convert::From<&str> for MdiIcon {
    fn from(s: &str) -> Self {
        match s {
            ...
            "alert" => MdiIcon::Alert,
            "alert-triangle" => MdiIcon::AlertTriangle,
            ...
            "mail" => MdiIcon::Mail,
            "chat" => MdiIcon::Chat,
            "message-square" => MdiIcon::MessageSquare,
            ...
            "panel" => MdiIcon::Panel,
            "maximize-2" => MdiIcon::Maximize2,
            "chevrons-up-down" => MdiIcon::ChevronsUpDown,
            "tune" => MdiIcon::Tune,
            "pulse" => MdiIcon::Pulse,
